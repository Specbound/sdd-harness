...
├── daily/                     # DAILY — morning brief outputs (one file per day)
│   └── YYYY-MM-DD-brief.md    # written by daily-maintenance Step D; draft-only
...
| Daily | `daily/YYYY-MM-DD-brief.md` | On demand — morning orientation | 150 words per brief |
