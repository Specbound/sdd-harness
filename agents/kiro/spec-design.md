...
- `.claude/kiro/settings/templates/specs/design.md` for document structure
- `.claude/kiro/settings/rules/design-principles.md` for design principles
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `.claude/kiro/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `.claude/kiro/settings/rules/design-discovery-light.md`
...
1. **Load Design Template and Rules**:
   - Read `.claude/kiro/settings/templates/specs/design.md` for structure
   - Read `.claude/kiro/settings/rules/design-principles.md` for principles
...
**Note**: The actual design document follows `.claude/kiro/settings/templates/specs/design.md` structure.
...
**Template Missing**:
- **User Message**: "Template file missing at `.claude/kiro/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`.claude/kiro/settings/rules/design-discovery-full.md`)
