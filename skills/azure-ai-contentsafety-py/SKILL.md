...
description: >-
  Azure AI Content Safety SDK for Python — detect harmful content in text and images
  with multi-severity classification. Triggers: ContentSafetyClient, content moderation,
