---
name: javascript-pro
description: "JavaScript expert: ES6+, async patterns, event loop, Node.js/browser APIs. Use for JS architecture, async debugging, performance, or legacy migration."
metadata:
  model: inherit
risk: unknown
source: community
