...
- YAML frontmatter
- 500-line rule
- Bulk skill library creation or batch additions (source: 2026-06-09 observation)
...
### ✓ In-place skill augmentation
When extending an existing skill with new patterns or knowledge, edit the canonical SKILL.md directly rather than forking. Add new sections (Patterns, Anti-Patterns, When to Use) to maintain a single source of truth. (source: 2026-06-08 observation)
