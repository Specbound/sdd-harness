...
description: >-
  Azure AI Text Analytics SDK for Python — sentiment analysis, entity recognition, key
  phrases, language detection, PII, healthcare NLP. Triggers: TextAnalyticsClient,
  sentiment analysis, entity recognition, key phrase, PII detection.
