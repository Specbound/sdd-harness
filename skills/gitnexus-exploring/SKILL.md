...
3. mcp__gitnexus__query({query: "<what you want to understand>"})  → Find related execution flows
4. mcp__gitnexus__context({name: "<symbol>"})            → Deep dive on specific symbol
