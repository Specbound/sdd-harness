...
description: >-
  Azure App Configuration SDK for Python — centralized configuration, feature flags, and
  dynamic settings. Triggers: AzureAppConfigurationClient, feature flags, configuration,
  key-value settings.
