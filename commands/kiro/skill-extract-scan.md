---
description: Analyze a repository and identify extractable skills
...
Analyze a repository to identify modules that contain reusable procedural knowledge, score them against the extraction rubric, and produce a reviewable extraction plan.
...
Next steps:
1. Review the plan — edit or remove candidates you don't want
