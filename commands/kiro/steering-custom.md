...
- .claude/kiro/settings/templates/steering-custom/*.md
...
Available templates in `.claude/kiro/settings/templates/steering-custom/`:
...
- `.claude/kiro/settings/` content should NOT be documented (it's metadata, not project knowledge)
