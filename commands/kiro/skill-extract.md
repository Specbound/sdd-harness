---
description: Generate SKILL.md files from a repository or extraction plan
...
Generate SKILL.md files from an approved extraction plan, or run the full pipeline (scan + generate) in one step.
...
To verify:
- Read any generated SKILL.md to check quality
- Test activation by mentioning trigger keywords in a new conversation
```
