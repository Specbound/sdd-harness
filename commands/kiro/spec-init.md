...
3. **Initialize Files Using Templates**:
   - Read `.claude/kiro/settings/templates/specs/init.json`
   - Read `.claude/kiro/settings/templates/specs/requirements-init.md`
...
- **Template Missing**: If template files don't exist in `.claude/kiro/settings/templates/specs/`, report error with specific missing file path and suggest checking repository setup
