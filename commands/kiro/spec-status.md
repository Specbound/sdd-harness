...
- Read `specs/$1/spec.json` for metadata and phase status
- Read existing files: `requirements.md`, `design.md`, `tasks.md` (if they exist)
- Check `specs/$1/` directory for available files
...
**Spec Not Found**:
- **Message**: "No spec found for `$1`. Check available specs in `specs/`"
...
- Shows all specs in `specs/` with their status
