...
|---|---|---|
| **macOS** | launchd LaunchAgent | `bash ~/.claude/sdd-harness/scripts/orchestration/setup-mac-orchestrator.sh --force` |
| **Linux** | crontab | `bash ~/.claude/sdd-harness/scripts/orchestration/setup-linux-orchestrator.sh --force` |
| **WSL / Windows** | Windows Task Scheduler | `bash ~/.claude/sdd-harness/scripts/orchestration/setup-global-orchestrator.sh --force` |
